...
version = "0.1"
group = "com.example.blocking.binders"
...
dependencies {
    ...
    testImplementation("com.agorapulse:gru-micronaut")
}


application {
    mainClass = "com.example.blocking.binders.Application"
}
java {
...
micronaut {
    ...
    processing {
        incremental(true)
        annotations("com.example.blocking.binders.*")
    }
    aot {
